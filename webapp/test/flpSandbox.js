		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Empresa de Evento",
									"targetURL": "#eventoeventoproyecto1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eventoeventoproyecto1-display": {
								"semanticObject": "eventoeventoproyecto1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=evento.eventoproyecto1",
									"url": sap.ui.require.toUrl("evento/eventoproyecto1")
								}
							}
						}
					}
